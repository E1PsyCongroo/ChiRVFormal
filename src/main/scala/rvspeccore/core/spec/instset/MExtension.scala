...
trait MExtensionInsts {
  ...
  val MUL    = Inst("MUL", "b0000001_?????_?????_000_?????_0110011")
  val MULH   = Inst("MULH", "b0000001_?????_?????_001_?????_0110011")
  val MULHSU = Inst("MULHSU", "b0000001_?????_?????_010_?????_0110011")
  val MULHU  = Inst("MULHU", "b0000001_?????_?????_011_?????_0110011")
  val DIV    = Inst("DIV", "b0000001_?????_?????_100_?????_0110011")
  val DIVU   = Inst("DIVU", "b0000001_?????_?????_101_?????_0110011")
  val REM    = Inst("REM", "b0000001_?????_?????_110_?????_0110011")
  val REMU   = Inst("REMU", "b0000001_?????_?????_111_?????_0110011")

  // - RV64M Standard Extension (in addition to RV32M)
  val MULW  = Inst("MULW", "b0000001_?????_?????_000_?????_0111011")
  val DIVW  = Inst("DIVW", "b0000001_?????_?????_100_?????_0111011")
  val DIVUW = Inst("DIVUW", "b0000001_?????_?????_101_?????_0111011")
  val REMW  = Inst("REMW", "b0000001_?????_?????_110_?????_0111011")
  val REMUW = Inst("REMUW", "b0000001_?????_?????_111_?????_0111011")
